...
class FilezillaAccountController: public QObject
{
    ...
    void addNewUser(const QString &username, const QString &password, bool createServerDir);
...
public:
    ...
    void createOrUpdateUser(const QString &username, const QString &password, bool createServerDir);
